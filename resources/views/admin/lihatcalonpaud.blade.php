        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body py-md-4 px-md-5">
                ...
                <div class="mb-3">
                    ...
                    <input disabled type="text" name="nomorinduk" class="form-control" id="nomorinduk" value="{{ $data['paud'][0]->nomorinduk }}" required>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <div id="jk">
                                ...
                                <div class="custom-control custom-radio">
                                    <input disabled {{ $data['calon'][0]->jeniskelamin == 'Perempuan' ? 'checked':'' }} type="radio" id="jk2" name="jeniskelamin" value="Perempuan" class="custom-control-input disabled" required>
                ...
                <div class="mb-3">
                    ...
                    <input disabled type="text" name="citacita" class="form-control" id="citacita" value="{{ $data['paud'][0]->citacita }}" required>
                </div>
                <div class="mb-3">
                    <label for="hobi" class="form-label">Hobi<span class="text-danger">*</span></label>
                    <input disabled type="text" name="hobi" class="form-control" id="hobi" value="{{ $data['paud'][0]->hobi }}" required>
                </div>
                <div class="mb-3">
                    <label for="jmlsaudara" class="form-label">Jumlah Saudara Kandung<span class="text-danger">*</span></label>
                    <input disabled type="text" name="jmlsaudara" class="form-control" id="jmlsaudara" value="{{ $data['paud'][0]->jmlsaudara }}" required>
                </div>
                <div class="mb-3">
                    <label for="jaraksekolah" class="form-label">Jarak Tempuh Ke Sekolah (KM)<span class="text-danger">*</span></label>
                    <input disabled type="number" name="jaraksekolah" class="form-control" id="jaraksekolah" value="{{ $data['paud'][0]->jaraksekolah }}" required>
                </div>
                <div class="mb-3">
                    <label for="kendaraan" class="form-label">Kendaraan Yang Digunakan<span class="text-danger">*</span></label>
                    <input disabled type="text" name="kendaraan" class="form-control" id="kendaraan" value="{{ $data['paud'][0]->kendaraan }}" required>
                </div>
                <div class="mb-3">
                    <label for="beratbadan" class="form-label">Berat Badan<span class="text-danger">*</span></label>
                    <input disabled type="number" name="beratbadan" class="form-control" id="beratbadan" value="{{ $data['paud'][0]->beratbadan }}" required>
                </div>
                <div class="mb-3">
                    <label for="tinggibadan" class="form-label">Tinggi Badan<span class="text-danger">*</span></label>
                    <input disabled type="number" name="tinggibadan" class="form-control" id="tinggibadan" value="{{ $data['paud'][0]->tinggibadan }}" required>
                </div>
                <div class="mb-3">
                    <label for="lingkarkepala" class="form-label">Lingkar Kepala<span class="text-danger">*</span></label>
                    <input disabled type="number" name="lingkarkepala" class="form-control" id="lingkarkepala" value="{{ $data['paud'][0]->lingkarkepala }}" required>
                </div>
                <div class="mb-3">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body py-md-4 px-md-5">
                <div class="mb-3">
                    ...
                    <input disabled type="text" name="namaayah" class="form-control" id="namaayah" value="{{ $data['paud'][0]->namaayah }}" required>
                </div>
                <div class="mb-3">
                    <label for="nikayah" class="form-label">NIK Ayah<span class="text-danger">*</span></label>
                    <input disabled type="text" name="nikayah" class="form-control" id="nikayah" value="{{ $data['paud'][0]->nikayah }}" required>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-6 mb-3">
                        <label for="tempatlahirayah" class="form-label">Tempat Lahir Ayah<span class="text-danger">*</span></label>
                        <input disabled type="text" name="tempatlahirayah" class="form-control" id="tempatlahirayah" value="{{ $data['paud'][0]->tempatlahirayah }}" required>
                    </div>
                    <div class="col-sm-12 col-md-6 mb-3">
                        <label for="tgllahirayah" class="form-label">Tanggal Lahir Ayah<span class="text-danger">*</span></label>
                        <input disabled type="date" name="tgllahirayah" class="form-control" id="tgllahirayah" value="{{ $data['paud'][0]->tgllahirayah }}" required>
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input disabled type="text" name="teleponayah" class="form-control" id="teleponayah" value="{{ $data['paud'][0]->teleponayah }}" required>
                </div>
                <div class="mb-3">
                    <label for="alamatayah" class="form-label">Alamat Ayah <span class="text-danger">*</span></label>
                    <input disabled type="text" name="alamatayah" class="form-control" id="alamatayah" value="{{ $data['paud'][0]->alamatayah }}" required>
                </div>
                <div class="mb-3">
                    <label for="penghasilanayah" class="form-label">Penghasilan Ayah (RP)<span class="text-danger">*</span></label>
                    <input disabled type="number" name="penghasilanayah" class="form-control" id="penghasilanayah" value="{{ $data['paud'][0]->penghasilanayah }}" required>
                </div>
                <hr class="my-4">
                <div class="mb-3">
                    <label for="namaibu" class="form-label">Nama Ibu<span class="text-danger">*</span></label>
                    <input disabled type="text" name="namaibu" class="form-control" id="namaibu" value="{{ $data['paud'][0]->namaibu }}" required>
                </div>
                <div class="mb-3">
                    <label for="nikibu" class="form-label">NIK Ibu<span class="text-danger">*</span></label>
                    <input disabled type="text" name="nikibu" class="form-control" id="nikibu" value="{{ $data['paud'][0]->nikibu }}" required>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-6 mb-3">
                        <label for="tempatlahiribu" class="form-label">Tempat Lahir Ibu<span class="text-danger">*</span></label>
                        <input disabled type="text" name="tempatlahiribu" class="form-control" id="tempatlahiribu" value="{{ $data['paud'][0]->tempatlahiribu }}" required>
                    </div>
                    <div class="col-sm-12 col-md-6 mb-3">
                        <label for="tgllahiribu" class="form-label">Tanggal Lahir Ibu<span class="text-danger">*</span></label>
                        <input disabled type="date" name="tgllahiribu" class="form-control" id="tgllahiribu" value="{{ $data['paud'][0]->tgllahiribu }}" required>
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input disabled type="text" name="teleponibu" class="form-control" id="teleponibu" value="{{ $data['paud'][0]->teleponibu }}" required>
                </div>
                <div class="mb-3">
                    <label for="alamatibu" class="form-label">Alamat Ibu <span class="text-danger">*</span></label>
                    <input disabled type="text" name="alamatibu" class="form-control" id="alamatibu" value="{{ $data['paud'][0]->alamatibu }}" required>
                </div>
                <div class="mb-3">
                    <label for="penghasilanibu" class="form-label">Penghasilan Ibu (RP)<span class="text-danger">*</span></label>
                    <input disabled type="number" name="penghasilanibu" class="form-control" id="penghasilanibu" value="{{ $data['paud'][0]->penghasilanibu }}" required>
                </div>
                <div class="mb-3">
                    <small><span class="text-danger">*</span> Wajib diisi</small>
                </div>
            ...
            <div class="text-center mx-3 mb-3">
                <button onclick="history.back()" class="btn btn-lg btn-secondary px-5 mx-1">Kembali</button>
            </div>
        </div>
        <hr>
    </form>
...
<script src="{{ asset('js/bs-custom-file-input disabled.js') }}"></script>
<script>
