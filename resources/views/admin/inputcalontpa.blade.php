...
@section('content')
<form action="{{ route('dashboard.psb.data.storetpa') }}" enctype="multipart/form-data" method="POST">
...
<div class="card-body py-md-4 px-md-5">
    ...
    <div class="mb-3">
        <label for="penghasilanayah" class="form-label">Penghasilan Ayah<span class="text-danger">*</span></label>
    ...
    <div class="mb-3">
        <label for="penghasilanibu" class="form-label">Penghasilan Ibu<span class="text-danger">*</span></label>
...
<div class="text-center mx-3 mb-3">
    <button type="submit" class="btn btn-lg btn-thoriq px-5">Tambah</button>
</div>
</div>
<hr>
</form>
