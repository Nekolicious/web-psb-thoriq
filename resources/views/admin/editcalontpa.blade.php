...
<div class="container-fluid">
    ...
    <!-- Form -->
    <form action="{{ route('dashboard.psb.data.updatetpa') }}" enctype="multipart/form-data" method="POST">
        <div class="card shadow mb-4">
            ...
            <div class="card-body py-md-4 px-md-5">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nism" class="form-control" id="nism" value="{{ $data['tpa'][0]->nism }}" required>
                </div>
                <div class="mb-3">
                    <label for="nisn" class="form-label">NISN<span class="text-danger">*</span></label>
                    <input type="text" name="nisn" class="form-control" id="nisn" value="{{ $data['tpa'][0]->nisn }}" required>
                </div>
                <div class="mb-3">
                    <label for="nik" class="form-label">NIK<span class="text-danger">*</span></label>
                    <input type="text" name="nik" class="form-control" id="nik" value="{{ $data['tpa'][0]->nik }}" required>
                </div>
                <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="jk">
                                <div class="custom-control custom-radio">
                                    <input {{ $data['calon'][0]->jeniskelamin == 'Laki-laki' ? 'checked':'' }} type="radio" id="jk1" name="jeniskelamin" value="Laki-laki" class="custom-control-input disabled" required>
                                    <label class="custom-control-label" for="jk1">Laki-laki</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input {{ $data['calon'][0]->jeniskelamin == 'Laki-laki' ? 'checked':'' }} type="radio" id="jk2" name="jeniskelamin" value="Perempuan" class="custom-control-input disabled" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="hobi" class="form-control" id="hobi" value="{{ $data['tpa'][0]->hobi }}" required>
                </div>
                <div class="mb-3">
                    <label for="citacita" class="form-label">Cita-Cita<span class="text-danger">*</span></label>
                    <input type="text" name="citacita" class="form-control" id="citacita" value="{{ $data['tpa'][0]->citacita }}" required>
                </div>
                <div class="mb-3">
                    <label for="anakke" class="form-label">Anak Ke-<span class="text-danger">*</span></label>
                    <input type="text" name="anakke" class="form-control" id="anakke" value="{{ $data['tpa'][0]->anakke }}" required>
                </div>
                <div class="mb-3">
                    <label for="jmlsaudara" class="form-label">Jumlah Saudara<span class="text-danger">*</span></label>
                    <input type="text" name="jmlsaudara" class="form-control" id="jmlsaudara" value="{{ $data['tpa'][0]->jmlsaudara }}" required>
                </div>
                <div class="mb-3">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body py-md-4 px-md-5">
                <div class="mb-3">
                    ...
                    <input type="text" name="namaayah" class="form-control" id="namaayah" value="{{ $data['tpa'][0]->namaayah }}" required>
                </div>
                <div class="mb-3">
                    <label for="nikayah" class="form-label">NIK Ayah<span class="text-danger">*</span></label>
                    <input type="text" name="nikayah" class="form-control" id="nikayah" value="{{ $data['tpa'][0]->nikayah }}" required>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-6 mb-3">
                        <label for="tempatlahirayah" class="form-label">Tempat Lahir Ayah<span class="text-danger">*</span></label>
                        <input type="text" name="tempatlahirayah" class="form-control" id="tempatlahirayah" value="{{ $data['tpa'][0]->tempatlahirayah }}" required>
                    </div>
                    <div class="col-sm-12 col-md-6 mb-3">
                        <label for="tgllahirayah" class="form-label">Tanggal Lahir Ayah<span class="text-danger">*</span></label>
                        <input type="date" name="tgllahirayah" class="form-control" id="tgllahirayah" value="{{ $data['tpa'][0]->tgllahirayah }}" required>
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="teleponayah" class="form-control" id="teleponayah" value="{{ $data['tpa'][0]->teleponayah }}" required>
                </div>
                <div class="mb-3">
                    <label for="alamatayah" class="form-label">Alamat Ayah <span class="text-danger">*</span></label>
                    <input type="text" name="alamatayah" class="form-control" id="alamatayah" value="{{ $data['tpa'][0]->alamatayah }}" required>
                </div>
                <div class="mb-3">
                    <label for="penghasilanayah" class="form-label">Penghasilan Ayah (RP)<span class="text-danger">*</span></label>
                    <input type="number" name="penghasilanayah" class="form-control" id="penghasilanayah" value="{{ $data['tpa'][0]->penghasilanayah }}" required>
                </div>
                <hr class="my-4">
                <div class="mb-3">
                    <label for="namaibu" class="form-label">Nama Ibu<span class="text-danger">*</span></label>
                    <input type="text" name="namaibu" class="form-control" id="namaibu" value="{{ $data['tpa'][0]->namaibu }}" required>
                </div>
                <div class="mb-3">
                    <label for="nikibu" class="form-label">NIK Ibu<span class="text-danger">*</span></label>
                    <input type="text" name="nikibu" class="form-control" id="nikibu" value="{{ $data['tpa'][0]->nikibu }}" required>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-6 mb-3">
                        <label for="tempatlahiribu" class="form-label">Tempat Lahir Ibu<span class="text-danger">*</span></label>
                        <input type="text" name="tempatlahiribu" class="form-control" id="tempatlahiribu" value="{{ $data['tpa'][0]->tempatlahiribu }}" required>
                    </div>
                    <div class="col-sm-12 col-md-6 mb-3">
                        <label for="tgllahiribu" class="form-label">Tanggal Lahir Ibu<span class="text-danger">*</span></label>
                        <input type="date" name="tgllahiribu" class="form-control" id="tgllahiribu" value="{{ $data['tpa'][0]->tgllahiribu }}" required>
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="teleponibu" class="form-control" id="teleponibu" value="{{ $data['tpa'][0]->teleponibu }}" required>
                </div>
                <div class="mb-3">
                    <label for="alamatibu" class="form-label">Alamat Orangtua Ibu <span class="text-danger">*</span></label>
                    <input type="text" name="alamatibu" class="form-control" id="alamatibu" value="{{ $data['tpa'][0]->alamatibu }}" required>
                </div>
                <div class="mb-3">
                    <label for="penghasilanibu" class="form-label">Penghasilan Ibu (RP)<span class="text-danger">*</span></label>
                    <input type="number" name="penghasilanibu" class="form-control" id="penghasilanibu" value="{{ $data['tpa'][0]->penghasilanibu }}" required>
                </div>
